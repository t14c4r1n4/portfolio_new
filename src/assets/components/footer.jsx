...
const footerIconProps = {
  className:
    "size-8 transition-transform duration-300 group-hover:scale-115 group-hover:opacity-100 opacity-50 fill-zinc-600 rounded-2xl",
};
...
export default function Footer() {
  ...
  return (
    <footer className="fixed bottom-0 w-full bg-zinc-900 p-4 z-3">
      <div className="flex flex-cols w-[30vw] justify-center divide-x space-x-5 container">
        <div>
          <a
            href="/impressum"
